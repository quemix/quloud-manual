...
ボードアイコンをクリックすると、Tenant の保有ポイント数、有効期限、ストレージ利用状況が確認できます。

.. image:: images/screenshot_0233.png
...
ヘッダー部の「？」のアイコンをクリックし、「Terms of service」をクリックします。

.. image:: images/screenshot_0166.png

すると、利用規約が確認できます。

.. image:: images/screenshot_0167.png
