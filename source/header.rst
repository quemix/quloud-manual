...
.. figure:: images/v70/header_icons.png
   :alt: 画面上端のヘッダー。左に Quloud のロゴと version 7.0.0 の表示、右に丸に i・丸に疑問符・ボード・歯車・アカウントのアバターの 5 つのアイコンが並んでいる。
...
「ジョブ使用」の行のうち、退会したユーザーの Job を引き継いだ分には、「理由」列に
「（退会ユーザーの削除済みジョブ）」という注記が付きます。退会したユーザーの Job は、
テナントに残っている最も古いオーナーへ引き継がれるためです。
