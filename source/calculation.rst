...
.. image:: images/screenshot_0189.png
.. image:: images/screenshot_0190.png
...
On-The-Fly MD とは異なり、事前に機械学習されたポテンシャルを利用して、構造最適化（OPT）あるいは MD シミュレーションを行います。
利用するソフトウェアは ASE-MD です。
...
この計算を行うには 8.4.1 の自己無撞着な電子状態計算をあらかじめ完了させておく必要があり、
