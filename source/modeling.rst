...
（Interface, Add Molecule, Add Cell モデリングには、「Overwrite」機能はありません。）
...
Material が Molecule の場合には、モデリングタイプ「Add Cell」が選択できます。

.. image:: images/screenshot_0142.png

ここでは、例えば xyz 形式のような、ユニットセルの情報を持たない孤立分子の構造に、
ユニットセルの情報を追加してスーパーセルモデルを作成することができます。

.. image:: images/screenshot_0143.png

スーパーセルモデルを作成し、Material として保存すると、周期系専用の第一原理計算ソフト等を用いて、分子に対する計算が可能になります。

.. image:: images/screenshot_0144.png